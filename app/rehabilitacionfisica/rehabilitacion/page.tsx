...
export const metadata = {
  title: "Rehabiliacion fisica y neurologica | Mente Abierta",
  description:
    "Terapia ocupacional en Rehabilitación física y neurológica. Asesoramiento a usuarios, familias y cuidadores",
};
