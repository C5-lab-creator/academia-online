  ...
  return (
    <main>
      ...
      <section className="flex flex-col-reverse md:flex-row items-center justify-between gap-8 px-6 py-8 max-w-7xl mx-auto">
        ...
        {/* Texto */}
        <div className="flex-1 text-center md:text-left text-gray-700">

          <h3 className="text-2xl md:text-4xl font-bold mb-6 text-blue-900">
          ...
          <p className="font-semibold italic text-lg text-gray-800">
      ...
      <section className="px-6 py-12 max-w-5xl mx-auto">
        ...
        <h3 className="text-2xl md:text-3xl font-bold mb-6 text-center text-blue-900">
          ¿Por qué elegir Mente Abierta?
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-base md:text-lg text-gray-700">
