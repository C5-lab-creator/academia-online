      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-8 mb-6">
                Clases particulares especializadas de Química Analítica para
                estudiantes universitarios. Te ayudamos a comprender la teoría,
                resolver problemas y preparar con éxito prácticas y exámenes,
                adaptando cada sesión a tus objetivos y ritmo de aprendizaje.
              </p>
            ...
            <div className="w-full md:w-96">
              ...
              <Image
                src="/quimicaanalitica.jpeg"
                alt="Química Analítica"
                width={450}
                height={320}
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-14">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Adaptadas al nivel de cada estudiante universitario y enfocadas
              en superar la asignatura con seguridad.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Clases en directo mediante pizarra digital, con materiales y
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <p className="text-gray-700 text-lg mb-8">
            Si tienes dudas sobre las clases de Química Analítica, la
            disponibilidad o la metodología, estaremos encantados de ayudarte.
          </p>
