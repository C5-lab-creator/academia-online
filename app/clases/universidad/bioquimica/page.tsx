...
export const metadata = {
  ...
  description:
    "Clases particulares de bioquimica para universitarios estudiantes de medicina y otras carreras relacionadas.",
};
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-8 mb-6">
                Clases particulares de Bioquímica para estudiantes universitarios,
                adaptadas al nivel y objetivos de cada alumno. Trabajamos la
                comprensión de los conceptos, la resolución de ejercicios y la
                preparación de prácticas y exámenes.
              </p>

              <Link href="/reservas?servicio=bioquimica">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-14">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Adaptadas al nivel de cada estudiante y centradas en alcanzar sus
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Resolución de ejercicios, prácticas, boletines y preparación de
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <p className="text-gray-700 text-lg mb-8">
            Si tienes dudas sobre nuestras clases de Bioquímica, la metodología,
            la disponibilidad o deseas recibir asesoramiento personalizado,
