      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-8 mb-6">
                Clases particulares de Química Física dirigidas a estudiantes
                universitarios, adaptadas al nivel, objetivos y necesidades de
                cada alumno. Trabajamos la comprensión de los principios
                fisicoquímicos mediante una metodología clara, práctica y
                personalizada.
              </p>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-14">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Adaptadas al nivel y ritmo de aprendizaje de cada estudiante,
              facilitando la comprensión de los conceptos fundamentales.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <p className="text-gray-700 text-lg mb-8">
            Si tienes dudas sobre nuestras clases de Química Física, la
