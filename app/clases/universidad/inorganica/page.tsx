...
export const metadata = {
  ...
  description:
    "Clases particulares de quimica inorganica para universitarios",
};
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-8 mb-6">
                Clases particulares de Química Inorgánica para estudiantes
                universitarios de diferentes grados, adaptadas al nivel,
                objetivos y necesidades de cada alumno. Trabajamos tanto la
                comprensión de la teoría como la resolución de ejercicios,
                problemas y preparación de prácticas y exámenes.
              </p>

              <Link href="/reservas?servicio=quimicainorganica">
            ...
            <div className="w-full md:w-96">
              ...
              <Image
                src="/quimicainorganica.jpeg"
                alt="Química Inorgánica"
                width={450}
                height={320}
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-14">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Explicaciones adaptadas al nivel y ritmo de aprendizaje de cada
              estudiante para facilitar la comprensión de la asignatura.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Resolución de problemas, boletines, prácticas de laboratorio y
              preparación específica para exámenes universitarios.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              ...
              personalizado y material complementario.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-700">
            ...
            <ul className="space-y-4">
              <li>✅ Explicación clara y sencilla de la teoría.</li>
              <li>✅ Resolución guiada de ejercicios.</li>
              <li>✅ Preparación de prácticas de laboratorio.</li>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <p className="text-gray-700 text-lg mb-8">
            Si tienes dudas sobre nuestras clases de Química Inorgánica, la
