    ...
    <main className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="space-y-8">
        ...
        <div className="curso">
          ...
          <p className="text-gray-700">
            Clases particulares de Química Inorgánica para alumnos
            universitarios de diferentes grados, adaptadas al nivel y
      ...
      <section className="mt-12">
        ...
        <p className="text-gray-700 mb-6">
          Para más información sobre las clases de Química Inorgánica,
