...
export const metadata = {
  title: "Acceso a la Universidad para Mayores de 25 | Mente Abierta",
  description:
    "Preparación online para la prueba de acceso a la universidad para mayores de 25 años, con apoyo personalizado, resolución de ejercicios y preparación de exámenes.",
};
      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1">
              ...
              <p className="text-gray-700 text-lg leading-8 mb-6">
                Preparamos todas las asignaturas de las pruebas de acceso para
                mayores de 25 años mediante una enseñanza personalizada,
                adaptada al nivel y objetivos de cada estudiante.
              </p>

              <Link href="/reservas?servicio=pruebasdeacceso">
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-14">
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Preparación completa de todas las asignaturas de la prueba de
              acceso, adaptándonos al nivel y ritmo de aprendizaje de cada
              estudiante.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              Elaboración de esquemas, explicación de conceptos, resolución de
              ejercicios y simulacros de examen para afrontar la prueba con
              confianza.
            </p>
          ...
          <div className="bg-white rounded-3xl shadow-xl p-8">
            ...
            <p className="text-gray-700 leading-7">
              ...
              personalizado y materiales adaptados a cada alumno.
            </p>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 text-gray-700">
            ...
            <ul className="space-y-4">
              ...
              <li>✅ Simulación de exámenes oficiales.</li>
            </ul>
        ...
        <div className="bg-blue-900 text-white rounded-3xl shadow-xl p-10 mb-12">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-lg">
            ...
            <p>✔ Clases intensivas antes de los exámenes.</p>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-10">
          ...
          <p className="text-gray-700 text-lg mb-8">
            Si deseas resolver cualquier duda sobre la preparación de las
            pruebas de acceso para mayores de 25 años o consultar
